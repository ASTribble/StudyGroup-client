Make sure the Github repository has a README by the time you're done. Your README should include: a description of your app, a link to a deployed version, 
